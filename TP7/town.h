...
public:
    ...
    bool operator<(const Town& town2)const {return (_name != town2.name())? _name < town2.name() : _coords < town2.point();}
    bool operator==(const Town& town2)const{return (_name==town2.name() && _coords == town2.point());}
    bool operator!=(const Town& town2)const{return not(_name==town2.name() && _coords == town2.point());}
};
